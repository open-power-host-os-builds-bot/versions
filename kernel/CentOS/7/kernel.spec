...
%changelog
* Thu Jun 07 2018 OpenPOWER Host OS Builds Bot <open-power-host-os-builds-bot@users.noreply.github.com> - 4.17.0-1.git
- Version update
- Updating to 5ce3eac Merge tag v4.17 into hostos-devel

* Fri May 25 2018 OpenPOWER Host OS Builds Bot <open-power-host-os-builds-bot@users.noreply.github.com> - 4.16.0-5.git
- Updating to 5ed4ce3 KVM: PPC: Book 3S HV: Do ptesync in radix guest exit path

* Wed May 16 2018 Fabiano Rosas <farosas@linux.ibm.com> - 4.16.0-4.git
- Bump due to config change

* Tue May 15 2018 OpenPOWER Host OS Builds Bot <open-power-host-os-builds-bot@users.noreply.github.com> - 4.16.0-3.git
- Updating to fd8742e KVM: PPC: Book3S HV: XIVE: Resend re-routed interrupts on
  CPU priority change
