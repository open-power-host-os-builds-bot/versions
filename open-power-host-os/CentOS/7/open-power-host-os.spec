...
Requires(post): libvirt = 4.5.0-1%{?extraver}.gitb7c8ea8%{dist}
...
%changelog
* Mon Jul 09 2018 OpenPOWER Host OS Builds Bot <open-power-host-os-builds-bot@users.noreply.github.com> - 3.5-39.dev
