...
Requires(post): kernel = 4.15.0-2.rc9%{?extraver}.git03552b2%{dist}
...
%changelog
* Tue Jan 23 2018 OpenPOWER Host OS Builds Bot <open-power-host-os-builds-bot@users.noreply.github.com> - 3.5-16.dev
