...
Requires(post): libservicelog = 1.1.18-1%{?extraver}.git1e39e77%{dist}
...
%changelog
* Fri Aug 25 2017 OpenPOWER Host OS Builds Bot <open-power-host-os-builds-bot@users.noreply.github.com> - 3.0-10.alpha
