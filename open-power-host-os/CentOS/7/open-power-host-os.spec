...
Requires(post): kernel = 4.16.0-2%{?extraver}.gitb24758c%{dist}
...
Requires(post): libvirt = 4.2.0-1%{?extraver}.gitbf217de%{dist}
...
%changelog
* Tue Apr 03 2018 OpenPOWER Host OS Builds Bot <open-power-host-os-builds-bot@users.noreply.github.com> - 3.5-28.dev
