...
%if 0%{?rhel}
    ...
    %if 0%{?rhel} >= 7
        %define qemu_kvm_arches x86_64 %{power64} aarch64 s390x ppc64le
    %endif
%endif
...
%changelog
* Tue Jul 10 2018 OpenPOWER Host OS Builds Bot <open-power-host-os-builds-bot@users.noreply.github.com> - 4.5.0-1.git
- Version update
