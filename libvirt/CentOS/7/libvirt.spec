...
%changelog
* Thu Nov 23 2017 OpenPOWER Host OS Builds Bot <open-power-host-os-builds-bot@users.noreply.github.com> - 3.9.0-1.git
- Version update
- Updating to 2c30e7b Fix the syntax-check failure
