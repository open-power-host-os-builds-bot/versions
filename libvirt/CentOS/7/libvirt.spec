...
%changelog
* Tue May 15 2018 OpenPOWER Host OS Builds Bot <open-power-host-os-builds-bot@users.noreply.github.com> - 4.2.0-1.git
- Version update
- Updating to bf217de Merge tag v4.2.0 into hostos-devel

* Sun Jan 21 2018 OpenPOWER Host OS Builds Bot <open-power-host-os-builds-bot@users.noreply.github.com> - 4.0.0-1.git
- Version update
