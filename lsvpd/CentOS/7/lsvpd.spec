...
%changelog
* Thu Feb 01 2018 OpenPOWER Host OS Builds Bot <open-power-host-os-builds-bot@users.noreply.github.com> - 1.7.8-4.git
- Updating to 63c0dfc Use ipmi usb interface to collect fru info
